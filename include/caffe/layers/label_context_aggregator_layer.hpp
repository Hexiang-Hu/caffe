...
class LabelContextAggregatorLayer : public Layer<Dtype> {
 public:
  explicit LabelContextAggregatorLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "LabelContextAggregator"; }
 ...
 protected:
  ...
  private:
  /*
    private variables for label context aggregation
  */
  float down_factor_;
  int window_;
  int pad_;
