...
class CategoryFilterLayer : public Layer<Dtype> {
 public:
  explicit CategoryFilterLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "CategoryFilter"; }
